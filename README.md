...
This project is licensed under the GNU General Public License v3.0 - see the [LICENSE](https://github.com/teelichtfoxy/rlreplaydecodercli/tree/main?tab=GPL-3.0-1-ov-file) file for details.
